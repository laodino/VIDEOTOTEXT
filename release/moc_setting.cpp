...
QT_MOC_LITERAL(1, 8, 9), // "sendblock"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5), // "block"
QT_MOC_LITERAL(4, 25, 21) // "on_pushButton_clicked"

    },
    "setting\0sendblock\0\0block\0on_pushButton_clicked"
};
...
void setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendblock((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&setting::sendblock)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void setting::sendblock(int _t1)
{
